...
| **ب. React Context خفيف** | مشروع MVP/معسكر، عدد قليل من النصوص، واجهة تعتمد على العميل (client) بشكل أساسي | بسيط؛ **يعمل على العميل فقط** (بلا روابط لكل لغة ولا ترجمة داخل مكوّنات الخادم) |
