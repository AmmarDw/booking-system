...
|---------|-------|----------|
| draw.io CLI not found | Desktop app not installed or not on PATH | Keep the `.drawio` file and tell the user they can open it **with no install** at <https://app.diagrams.net> (File → Open From → Device), or install the draw.io desktop app if they want CLI export |
